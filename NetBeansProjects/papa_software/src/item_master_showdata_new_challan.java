 ...
 */
public class item_master_showdata_new_challan extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;
     ...
     */
    public item_master_showdata_new_challan() {
        initComponents();
    ...
    private void jTable1_item_master_ShowdataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1_item_master_ShowdataMouseClicked
        ...
        try{
            ...
            String sql="Select ITEM_NAME from ITEM_MASTER where Item_no ='" + table_click + "  '";   
            pst=con.prepareStatement(sql);
            rs=  pst.executeQuery();
            if(rs.next()){
                ...
                NEW_CHALLAN frm=new NEW_CHALLAN();
                        frm.setVisible(true);
            
                        String add1=rs.getString("item_name");
                        frm.jTextFieldITEM_NAME.setText(add1);
